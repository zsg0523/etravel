...
<template>
    <div style="width:100%;">
        <div class="dataBank_input_form disflex"> 
            <!-- <div style="width:90%;height:45px;line-height:45px;text-align:center;background-color:#ffde01;font-size:18px;">學生名單</div> -->
            <table>
                <thead>
                    <tr>
                        <th>學生名單</th>
                ...
                <tbody>
                    <tr v-for="(group,index) in groups">
                        ...
                        <td>{{group.duty}}</td>
                        <td @click="$router.push('/answer/dataBankAnswerInfo/'+group.id)">查看></td>
                    </tr>
