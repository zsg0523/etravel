<style>
    ...
    .form_content{width: 94%;min-height: 120px;align-content:flex-start;flex-direction: row;flex-wrap: wrap;margin-left: 3%;}
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane active" id="journey">
                    <div class="pane_content">
                        <div class="form_content disflex" v-for="(journey,index) in journeys">
