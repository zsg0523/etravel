...
<template>
    <div style="width:100%;">
        <div class="right_title">
            <div class="title_icon" @click="$router.push('/promise/dataBankPromises')">
            ...
            <div class="pane_content">
                <div class="form_content disflex" v-for="(ruleInfo,index) in ruleInfos">
                    <div class="form_item_ruleInfo">
                        <div class="item_title">承诺详情{{index+1}}</div>
                        <div>
                            <textarea class="item_area" placeholder="承诺详情" disabled="disabled" :value="ruleInfo.rule"></textarea>
                        </div>
                    </div>
                    <div class="editBtnGroup">
		                <img @click="delRuleInfo(ruleInfo.id);" src="/etravel/public/images/rush-icon.png">
		                <img @click="editRuleInfoShow(index);" src="/etravel/public/images/edit-all.png">
		            </div>
                </div>
            </div>    
        ...
        <van-popup v-model="isNewRuleInfoShow" :overlay="true">
            <div class="editBox" >
                <div class="editBoxContent disflex">
                    <div class="form_item_ruleInfo">
                        <div class="item_title">承诺详情</div>
                        <div>
                            <textarea class="item_area" placeholder="承诺详情" v-model="newRuleInfo.rule"></textarea>
                        </div>
                    </div>
                    <div class="issure">
        ...
        <van-popup v-model="isEditRuleInfoShow" :overlay="true">
            <div class="editBox" >
                <div class="editBoxContent disflex">
                    <div class="form_item_ruleInfo">
                        <div class="item_title">承诺详情</div>
                        <div>
                            <textarea class="item_area" placeholder="承诺详情" v-model="edRuleInfo.rule"></textarea>
                        </div>
                    </div>
                    <div class="issure">
...
<script>
  	export default {
        ...
        methods:{
            getRuleInfos(){
                // 获取承诺详情/api/categories/3?include=rules
