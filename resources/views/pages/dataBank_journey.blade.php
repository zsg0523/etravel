@extends('layouts.app')
@section('breadlink')
    <a href="/">项目</a><<a href="/projectDetail">项目详情</a><<a href="/dataBank">资料库</a><<a class="onlink" href="">行程</a>
@endsection
@section('content')
<!DOCTYPE html>
...
<head>
    ...
    <style type="text/css">
        ...
        .form_item{width: 100%;height:50px;margin:10px 0;}
                ...
                <div class="dataBank_input_form disflex">
                    <div class="tablist">
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#gather" aria-controls="gather" role="tab" data-toggle="tab">行程安排</a></li>
                                    ...
                                    <div class="form_content disflex">
                                        <div class="form_item disflex">
                                            ...
                                            <div class="item_right">
                                                <img onclick="window.location.assign('/journeyInfo')" src="{{asset('images/See-next.png')}}">
                                            </div>
                                        </div>
                                        <div class="form_item disflex">
                                            <div class="item_left disflex">
                                ...
                                <div class="pane_content">
                                    <div class="form_content disflex">
                                        <div class="form_item disflex">
                                            ...
                                            <div class="item_right">
                                                <img onclick="window.location.assign('/mealsInfo')" src="{{asset('images/See-next.png')}}">
                                            </div>
                                        </div>
                                        <div class="form_item disflex">
                                            <div class="item_left disflex">
