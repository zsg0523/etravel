@extends('layouts.app')
@section('breadlink')
    <a href="/">项目</a><<a href="/projectDetail">项目详情</a><<a href="/dataBank">资料库</a><<a class="onlink" href="">常用电话</a>
@endsection
@section('content')
<!DOCTYPE html>
...
<head>
    ...
    <style type="text/css">
        ...
        .pane_content{width:70%;margin-left: 15%;height:auto;margin-bottom: 30px;font-size: 16px;background-color: #e6e6e6;border-radius: 15px;margin-top:20px;}
        ...
        <div class="dataBankList disflex">
            <div class="dataBank_left">
                <ul style="padding: 0;margin:0;">
                    ...
                    <li class="act"><div>常用电话<input type="checkbox" class="checke"></div></li>
                ...
                <div class="dataBank_input_form disflex">
                    <div class="tablist">
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#gather" aria-controls="gather" role="tab" data-toggle="tab">机构联系电话</a></li>
                            <li role="presentation"><a href="#flight" aria-controls="flight" role="tab" data-toggle="tab">紧急联系人</a></li>
                        </ul>
                            ...
                            <div role="tabpanel" class="tab-pane active" id="gather">
                                <div class="pane_content">
                                    <div class="form_content disflex">
                                        <div class="form_item">
                                            <div class="item_title">机构名称</div>
                                            <div><input class="item_input" placeholder="机构名称" type="text" name=""></div>
                                        </div>
                                        <div class="form_item">
                                ...
                                <div class="pane_content">
                                    <div class="form_content disflex">
                                        <div class="form_item">
                                            ...
                                            <div><input class="item_input" placeholder="联系人姓名" type="text" name=""></div>
                                        </div>
                                        <div class="form_item">
                                            <div class="item_title">联系电话</div>
                                            <div><input class="item_input" placeholder="联系电话" type="text" name=""></div>
                                        </div>
                                    </div>
                                </div>    
                                <div class="pane_content">
