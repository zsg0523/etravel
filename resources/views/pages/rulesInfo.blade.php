@extends('layouts.app')
@section('breadlink')
    <a href="/">项目</a><<a href="/projectDetail">项目详情</a><<a href="/dataBank">资料库</a><<a href="">团队守则</a><<a class="onlink" href="">详情</a>
@endsection
@section('content')
<!DOCTYPE html>
        ...
        <div class="dataBankList disflex">
            ...
            <div class="dataBank_right disflex">
                <div class="right_title">
                    <div class="title_icon" onclick="window.location.assign('dataBank_rules')">
