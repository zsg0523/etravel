@extends('layouts.app')
@section('breadlink')
    <a href="/">项目</a><<a href="/projectDetail">项目详情</a><<a href="/dataBank">资料库</a><<a class="onlink" href="">我的承诺</a>
@endsection
@section('content')
<!DOCTYPE html>
        ...
        <div class="dataBankList disflex">
            <div class="dataBank_left">
                <ul style="padding: 0;margin:0;">
                    ...
                    <li class="act"><div>我的承诺<input type="checkbox" checked="true" class="checke"></div></li>
                ...
                <div class="dataBank_input_form disflex">
                    <div class="pane_content">
                        <div class="form_content disflex">
                            <div class="form_item">
                                <div class="item_title">承诺01</div>
                                <div>
                                    <textarea class="item_area" placeholder="承诺01" ></textarea>
                                </div>
                            </div>
                            <div class="form_item">
                                <div class="item_title">承诺01</div>
