@extends('layouts.app')
@section('breadlink')
    <a href="/">项目</a><<a href="/projectDetail">项目详情</a><<a href="/dataBank">资料库</a><<a href="">行程安排</a><<a class="onlink" href="">Day.01</a>
@endsection
@section('content')
<!DOCTYPE html>
                    ...
                    <div class="pane_content">
                        <div class="form_content disflex">
                            ...
                            <div class="form_item" style="width:100%;height:120px;">
                                ...
                                <div>
                                    <textarea class="item_area" placeholder="地点"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form_content disflex">
