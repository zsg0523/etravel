@extends('layouts.app')
@section('breadlink')
    <a href="/">项目</a><<a href="/projectDetail">项目详情</a><<a href="/dataBank">资料库</a><<a class="onlink" href="">师生名单分组</a>
@endsection
@section('content')
<!DOCTYPE html>
        ...
        <div class="dataBankList disflex">
            <div class="dataBank_left">
                <ul style="padding: 0;margin:0;">
                    ...
                    <li class="act"><div>师生名单分组<input type="checkbox" checked="true" class="checke"></div></li>
