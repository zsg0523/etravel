@extends('layouts.app')
@section('breadlink')
    <a href="/">项目</a><<a href="/projectDetail">项目详情</a><<a href="/dataBank">资料库</a><<a class="onlink" href="">团队守则</a>
@endsection
@section('content')
<!DOCTYPE html>
...
<head>
    ...
    <style type="text/css">
        ...
        .dataBankAddBtn{width:70px;height: 70px;position: absolute;right: 50px;top: 80px;}
        .dataBankAddBtn:hover{cursor:pointer;}
        .dataBankAddBtn>img{width:70px;height: 70px;}

        .dataBankDelBtn{width:70px;height: 70px;position: absolute;right: 50px;top: 130px;}
        ...
        <div class="dataBankList disflex">
            <div class="dataBank_left">
                <ul style="padding: 0;margin:0;">
                    ...
                    <li class="act"><div>团队守则<input type="checkbox" checked="true" class="checke"></div></li>
                        ...
                        <div class="form_content disflex">
                            <div class="form_item">
                                ...
                                <div class="input_icon disflex">
                                    ...
                                    <div onclick="window.location.assign('/rulesInfo')">
                                        <img src="{{asset('images/See-next.png')}}" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="form_item">
                                <div class="item_title">准则02</div>
                                <div class="input_icon disflex">
                                    <input placeholder="准则" type="text" name="">
                                    <div onclick="window.location.assign('/rulesInfo')">
                                        <img src="{{asset('images/See-next.png')}}" alt="">
