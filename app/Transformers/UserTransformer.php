...
{	
	...
	public function transform(User $user)
	{
		return [
			...
			'code_one' => isset($user->emergency) ? $user->emergency->code_one : '',
			'code_two' => isset($user->emergency) ? $user->emergency->code_two : '',
			'emergency_phone_one' => isset($user->emergency) ? $user->emergency->emergency_phone_one : '',
			'emergency_phone_two' => isset($user->emergency) ? $user->emergency->emergency_phone_two : '',
			'emergency_email_one' => isset($user->emergency) ? $user->emergency->emergency_email_one : '',
			'emergency_email_two' => isset($user->emergency) ? $user->emergency->emergency_email_two : '',
