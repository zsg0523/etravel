...
class Travel extends Model
{
    ...
    {
        return $this->belongsToMany(RuleCategory::class);
    }

    /** [rule_category_travels 一对多] */
    public function rule_category_travels()
    {
        return $this->hasMany(RuleCategoryTravel::class);
    }
