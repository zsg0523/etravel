...
{
    protected $fillable = ['travel_name', 'travel_at', 'travel_return','travel_introduction', 'urgency', 'assembly_station', 'assembly_at', 'dissolution_station', 'dissolution_at', 'add_by', 'travel_status', 'image', 'school_name'];
